...
public class OperationWithNotebook {
    ...
    public boolean notebookIsCorrect(HW6 notebook){
    ...
    public OperationWithNotebook(Set<HW6> notebooks) {
        OperationWithNotebook.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    }

    public OperationWithNotebook(Set<HW6> notebooks, List<Criterion> criterionList) {
        OperationWithNotebook.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
